...
export function AddZadacic(arg1:models.Zadacic):Promise<number>;

export function AskDocumentQuestion(arg1:number,arg2:string):Promise<string>;

export function CanAddProjectDocument(arg1:number):Promise<boolean>;

export function ChangeDocumentPhase(arg1:number,arg2:number):Promise<void>;
...
export function CreateDocumentWithPermissions(arg1:main.CreateDocumentWithPermissionsRequest,arg2:Array<number>,arg3:string):Promise<number>;
...
export function CreateWorkflowWithPhases(arg1:main.CreateWorkflowWithPhasesRequest):Promise<number>;
...
export function DeleteZadacic(arg1:number):Promise<void>;

export function DownloadDocumentVersion(arg1:number):Promise<Array<number>>;
...
export function GetAllUsersForDocuments():Promise<Array<models.Korisnici>>;
...
export function ListPhaseChangeRequestsByDocument(arg1:number):Promise<Array<models.ZahteviPromeneFaze>>;

export function ListRoles():Promise<Array<models.Uloge>>;

export function ListZadaciciByDocument(arg1:number):Promise<Array<models.Zadacic>>;
...
export function UpdateZadacicStatus(arg1:number,arg2:boolean):Promise<void>;

export function UploadDocument(arg1:models.UploadDocumentRequest,arg2:Array<number>,arg3:string):Promise<number>;

export function UploadDocumentVersion(arg1:number,arg2:any,arg3:Array<number>,arg4:string):Promise<number>;
